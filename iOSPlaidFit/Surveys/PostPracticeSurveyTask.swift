...
public var PostPracticeSurveyTask: ORKOrderedTask {
    ...
    questionStep1.text = "Practice Difficulty"
    ...
    questionStep2.text = "Personal Performance"
    ...
    questionStep3.text = "Practice Participation"
    ...
    questionStep4.text = "Amount of Practice Participation"
